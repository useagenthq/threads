...
// mem0's SDK can't be fenced at its transport, so the provider is refused at setup (// item 3): the agent never starts with a memory that a stale writer could still write.
