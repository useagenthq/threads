...
def _checks(req: Request, agent: str) -> None:
    """Policy (only a lead, or the operator, starts), team open, the agent listed, the
    concurrent cap (starting and running members count), then budget headroom."""
    w = req.w
