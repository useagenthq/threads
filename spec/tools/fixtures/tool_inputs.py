...
CASES_: tuple[tuple[str, Obj, bool], ...] = (
    ...
    ("tool_search", {"query": "jira"}, True),
    ("tool_search", {"query": "jira", "limit": 1}, True),
    ("tool_search", {"query": "jira", "limit": 10}, True),
    ("tool_search", {"query": ""}, False),
    ("tool_search", {"query": "jira", "limit": 0}, False),
    ("tool_search", {"query": "jira", "limit": 11}, False),
    ("tool_search", {"query": "jira", "limit": 2.5}, False),
    ("tool_search", {"query": "jira", "limit": "5"}, False),
    ("tool_search", {"query": "jira", "mode": "exact"}, False),
    ("tool_search", {}, False),
