...
from threads.log import Context, Event, ModelRequestEvent
from threads.loop import attempt, compact
...
def test_a_cancel_while_the_request_is_prepared_sends_nothing(
    ...
    async def reserving(rt: Runtime, answer: Draft | None) -> Halt | None:
