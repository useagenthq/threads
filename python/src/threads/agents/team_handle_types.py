...
class TeamWaitRefused:
    """invalid_request (no members, a mode that is neither "all", "any" nor a positive integer no
    greater than the member count, or a timeout_ms that is not a positive integer) is returned
