...
OpenAI caches prompts automatically; its info.cache declares &#123;ttl_ms: 86400000&#125; when params.prompt_cache_retention is "24h", else &#123;ttl_ms: 300000&#125;, the documented in-memory lower bound. openai("gpt-5.5") needs no limits: they come from spec/models/openai.v1.json, read from OpenAI's model pages. Pass it as agent(&#123;model: openai("gpt-5.5")&#125;).
