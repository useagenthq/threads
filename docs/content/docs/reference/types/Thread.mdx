...
<Field name="instructions" type={"string"}>
  Extra guidance for the summary, for example what to keep. Omitted: the default summary instructions.
</Field>

**Returns an error value** with one of these codes: `forbidden`, `branch_busy`, `branch_not_runnable`, `invalid_transition`.
