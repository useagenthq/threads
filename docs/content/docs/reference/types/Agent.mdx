...
**Returns an error value** with one of these codes: `invalid_config`, `missing_secret`, `unknown_preset`, `duplicate_name`, `capability_missing`, `mcp_unreachable`, `budget_unenforceable`, `permission_rule_invalid`, `hosted_tool_unsupported`, `egress_policy_unsupported`, `transport_fence_unsupported`.
