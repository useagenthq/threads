 ...
 * #1A65FE is --brand and #1A65FE is --brand-lift, both from app/theme.css. The card is drawn
...
export function brandImage(title: string, description?: string): ImageResponse {
  return generateOGImage({
    ...
    description,
    site: appName,
    icon: <LogoMark width={55} height={48} color="#1A65FE" />,
    primaryColor: "rgba(26, 101, 254, 0.35)",
    primaryTextColor: "#1A65FE",
  });
}
