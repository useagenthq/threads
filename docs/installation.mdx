...
- [Bun](https://bun.sh) for TypeScript. The core runs on Bun; the E2B adapter needs it.
...
<Tabs>
  <Tab title="TypeScript" icon="file-code">
    ...
    <Steps>
      ...
      <Step title="Add your app as a package">
      ...
      <Step title="Run your code">
        Put the [Quickstart](/quickstart) code in `typescript/packages/my-agent/index.ts` and run it:
  ...
  <Tab title="Python" icon="file-code-2">
